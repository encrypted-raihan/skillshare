...
const styles: Record<string, React.CSSProperties> = {
  ...
  empty: { padding: 32 16, textAlign: 'center', color: '#809087', fontSize: 14 },
  ...
  bubble: { maxWidth: '72%', padding: '10px 13px 7px', borderRadius: 16, fontSize: 15, lineHeight: 1.45, boxShadow: '0 2px 8px rgba(25,55,44,.04)' },
  mine: { background: '#14523e', color: '#fff', borderBottomRightRadius: 5 },
  theirs: { background: '#edf2ee', color: '#17352b', borderBottomLeftRadius: 5 },
  messageTime: { display: 'block', marginTop: 3, fontSize: 10, opacity: .65, textAlign: 'right' },
  composer: { display: 'flex', gap: 10, padding: 14, borderTop: '1px solid #e1e8e3', background: '#fff' },
  composerInput: { flex: 1, height: 46, padding: '0 14px', border: '1px solid #dce5df', borderRadius: 13, outline: 0, fontSize: 14, background: '#f8faf8' },
  sendButton: { width: 46, height: 46, display: 'grid', placeItems: 'center', border: 0, borderRadius: 13, background: '#14523e', color: '#fff', cursor: 'pointer' },
}
